...
/// The native menu-bar companion does not share the web panel's JavaScript
/// locale store. Follow macOS's preferred language so the companion behaves
/// like the rest of the menu bar without adding a second language setting.
enum RouterLanguage {
...
private enum RouterChineseText {
  static let values: [String: String] = [
    ...
    "Daily token usage chart. Hover a day for its exact token count.": "每日 token 用量图表。将鼠标悬停在某天上可查看准确 token 数。",
    "Show %@ usage": "显示 %@ 用量",
    "WEEKLY LEFT": "每周剩余",
