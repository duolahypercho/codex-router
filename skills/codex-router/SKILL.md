---
name: codex-router
description: "Orientation for custom (non-OpenAI) models in the Codex app: how codex-router exposes the app's native tools, and which companion skill to read for thread, browser, or computer-use work."
---
