...
description: Use the app-native codex_app tools to create, read, message, wait on, fork, rename, archive, and pin Codex threads and automations. Use when the user asks to manage Codex tasks.
---
